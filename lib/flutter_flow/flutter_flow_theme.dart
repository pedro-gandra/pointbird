...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF762EC2);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFFDADADA);
  ...
  late Color accent1 = const Color(0xFFACACAC);
  late Color accent2 = const Color(0xFFE0E3E7);
  ...
  late Color primaryButtonText = Color(0xFFFFFFFF);
}
