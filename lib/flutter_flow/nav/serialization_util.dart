      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case ViewPointsHubRow:
            return ViewPointsHubRow(data);
          case ViewHomeCompanyRow:
            return ViewHomeCompanyRow(data);
          case PollOptionsRow:
          ...
          case ViewPointsStatementRow:
            return ViewPointsStatementRow(data);
          case ViewHomeClientRow:
            return ViewHomeClientRow(data);
          case CouponsRow:
