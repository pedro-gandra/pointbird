...
class ExchangePointsWidget extends StatefulWidget {
  const ExchangePointsWidget({
    super.key,
  ...
  @override
  State<ExchangePointsWidget> createState() => _ExchangePointsWidgetState();
}

class _ExchangePointsWidgetState extends State<ExchangePointsWidget> {
  late ExchangePointsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExchangePointsModel());

    _model.pointAmountTextController ??= TextEditingController();
    _model.pointAmountFocusNode ??= FocusNode();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ViewHomeClientRow>>(
      future: (_model.requestCompleter ??= Completer<List<ViewHomeClientRow>>()
                    ...
                    children: [
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${exchangePointsViewHomeClientRow?.percentageLimit?.toString()}%',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Poppins',
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                ...
                                                focusNode:
                                                    _model.pointAmountFocusNode,
                                                onChanged: (_) =>
                                                    EasyDebounce.debounce(
                                                  '_model.pointAmountTextController',
                                                  Duration(milliseconds: 100),
                                                  () async {
                                                    if (functions.toInt(_model
                                                            .pointAmountTextController
                                                            .text) >
                                                        exchangePointsViewHomeClientRow!
                                                            .currentPoints!) {
                                                ...
                                                validator: _model
                                                    .pointAmountTextControllerValidator
                                                    .asValidator(context),
                                                inputFormatters: [
                                ...
                                if (stackViewClientsPlansRow?.idPlan != 3)
                                  Row(
                                    mainAxisSize: MainAxisSize.max,
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      ...
                                      Text(
                                        '${functions.changeInt(stackViewClientsPlansRow!.limitCoupons!, '-', stackViewClientsPlansRow!.coupons!).toString()}/${stackViewClientsPlansRow?.limitCoupons?.toString()}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Poppins',
                      ...
                      wrapWithModel(
                        ...
                        child: SimpleHeaderWidget(
                          parameter1: exchangePointsViewHomeClientRow?.name,
                          action: 'back',
                          font: 15,
                        ),
                      ),
