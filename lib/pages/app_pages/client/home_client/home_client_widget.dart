    ...
    return FutureBuilder<List<ViewHomeClient2Row>>(
      future:
          (_model.requestCompleter2 ??= Completer<List<ViewHomeClient2Row>>()
                ..complete(ViewHomeClient2Table().querySingleRow(
                  queryFn: (q) => q.eq(
                    'email',
                    currentUserEmail,
                  ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  valueOrDefault<String>(
                                    homeClientViewHomeClient2Row?.name,
                                    'name',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                          ...
                          Padding(
                            ...
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                if (homeClientViewHomeClient2Row!.companies! >
                                    0)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemBuilder:
                                            ...
                                            final listViewViewHomeClientRow =
                                                listViewViewHomeClientRowList[
                                                    listViewIndex];
                                            return InkWell(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            listViewViewHomeClientRow.name,
                                                                            'name',
                                                                          ),
                                                                          textAlign:
                                                                              TextAlign.start,
                                                      ...
                                                      Align(
                                                        ...
                                                        child: Text(
                                                          homeClientViewHomeClient2Row
                                                                      ?.companies ==
                                                                  0
                                                              ? 'You don\'t follow any companies yet. Start following now to accumulate points and get incredible discounts!'
                                                              : 'Follow more companies! Just insert the company code below:',
                                                          textAlign:
                                                              TextAlign.start,
                                                              ...
                                                              child: Text(
                                                                ...
                                                                style: FlutterFlowTheme.of(
                                                                    ...
                                                                    .override(
                                                                      fontFamily:
                                                                          'Poppins',
                                                                      color: (_model.errorMessageInsert != 'No company is registrated with this code') &&
                                                                              (_model.errorMessageInsert !=
                                                                                  'You already follow this company')
                                                                          ? FlutterFlowTheme.of(context)
                                                                              .accent4
                                                                          : FlutterFlowTheme.of(context)
                                                                              .error,
