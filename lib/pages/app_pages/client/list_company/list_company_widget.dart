                  ...
                  children: [
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(
                          19.0, 75.0, 18.0, 80.0),
                      child: FutureBuilder<List<ViewHomeClientRow>>(
                        future: ViewHomeClientTable().queryRows(
                          queryFn: (q) => q
                              .eq(
                                'id_client',
                                widget!.idClient,
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.separated(
                            ...
                            itemCount: listViewViewHomeClientRowList.length,
                            separatorBuilder: (_, __) => SizedBox(height: 18.0),
                            itemBuilder: (context, listViewIndex) {
                              final listViewViewHomeClientRow =
                                  listViewViewHomeClientRowList[listViewIndex];
                              return Container(
