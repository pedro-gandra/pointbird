...
class _AnalyticsWidgetState extends State<AnalyticsWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiStatsResult = await CompanyStatsCall.call(
        startDate:
            functions.formatDate(functions.changeDate(getCurrentTimestamp, -7)),
          ...
          child: Stack(
            children: [
              RefreshIndicator(
                ...
                onRefresh: () async {
                  _model.apiStatsResultReload = await CompanyStatsCall.call(
                    startDate: functions.formatDate(
                        functions.changeDate(getCurrentTimestamp, -7)),
                    endDate: functions.formatDate(getCurrentTimestamp),
                    authEmail: currentUserEmail,
                  );
