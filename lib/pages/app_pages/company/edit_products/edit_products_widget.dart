...
class EditProductsWidget extends StatefulWidget {
  ...
  final ViewHomeCompanyRow? companyInfo;
  final dynamic json;

  @override
  State<EditProductsWidget> createState() => _EditProductsWidgetState();
}
...
class _EditProductsWidgetState extends State<EditProductsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.productState = (widget!.json!
              .toList()
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'o99ryern' /* Add your most popular products... */,
                                  ),
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  _model.addProduct = !_model.addProduct;
                                  setState(() {});
                                },
                                child: Row(
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '1n73hzhb' /* Link to the product page. This... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                    ...
                                                    }
                                                    {
                                                      ...
                                                      try {
                                                        ...
                                                        selectedMedia =
                                                          ...
                                                          selectedUploadedFiles,
                                                          storageFolderPath:
                                                              'userUploads/Business/${currentUserUid}/products',
                                                        );
                                                        downloadUrls =
                            ...
                            if (_model.productState.length > 0)
                              Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'w18idgmc' /* Tap and hold to reorder items */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                            ...
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final products = _model.productState.toList();
                                  ...
                                  return ReorderableListView.builder(
                                    ...
                                    itemBuilder: (context, productsIndex) {
                                      ...
                                      return Container(
                                        key: ValueKey("ListView_arzcz8op" +
                                            '_' +
                                    ...
                                    onReorder: (int reorderableOldIndex,
                                      ...
                                      _model.listOrdered =
                                          await actions.reorderProducts(
                                        _model.productState.toList(),
                                        reorderableOldIndex,
                                        reorderableNewIndex,
                                      );
                                      _model.productState = _model.listOrdered!
                                          .toList()
                                          .cast<ProductStruct>();
                                      setState(() {});
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await actions.supabaseProducts(
