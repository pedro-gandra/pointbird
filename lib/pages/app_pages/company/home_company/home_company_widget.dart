                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                if (homeCompanyViewHomeCompanyRow?.instagram !=
                                        null &&
                                    homeCompanyViewHomeCompanyRow?.instagram !=
                                        '')
                                  Opacity(
                                    opacity: 0.9,
                                    child: InkWell(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      if (homeCompanyViewHomeCompanyRow?.bio !=
                                              null &&
                                          homeCompanyViewHomeCompanyRow?.bio !=
                                              '')
                                        Text(
                                          valueOrDefault<String>(
                                            homeCompanyViewHomeCompanyRow?.bio,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        RatingBarIndicator(
                                          ...
                                          rating: homeCompanyViewHomeCompanyRow!
                                              .rating!,
                                          unratedColor:
                                              FlutterFlowTheme.of(context)
                                                  .secondaryText,
