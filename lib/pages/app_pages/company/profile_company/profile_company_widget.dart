...
import 'profile_company_model.dart';
export 'profile_company_model.dart';

class ProfileCompanyWidget extends StatefulWidget {
  const ProfileCompanyWidget({super.key});

  @override
  State<ProfileCompanyWidget> createState() => _ProfileCompanyWidgetState();
}

class _ProfileCompanyWidgetState extends State<ProfileCompanyWidget> {
  late ProfileCompanyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileCompanyModel());
  }
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      imageUrl:
                                          profileCompanyCompaniesRow!.imageUrl!,
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            profileCompanyCompaniesRow?.name,
                            'name',
                          ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            profileCompanyCompaniesRow?.email,
                            'email',
                          ),
                          style: FlutterFlowTheme.of(context)
                              .labelMedium
