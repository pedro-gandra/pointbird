...
class OnboardingCompanyWidget extends StatefulWidget {
  const OnboardingCompanyWidget({super.key});

  @override
  State<OnboardingCompanyWidget> createState() =>
      _OnboardingCompanyWidgetState();
}

class _OnboardingCompanyWidgetState extends State<OnboardingCompanyWidget> {
  late OnboardingCompanyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingCompanyModel());
